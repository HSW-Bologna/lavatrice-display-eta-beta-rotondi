...
static void open_page(pman_handle_t handle, void *state) {
    ...
    view_common_create_title(lv_scr_act(), view_intl_get_string(model, STRINGS_ARCHIVIAZIONE), BTN_BACK_ID, -1);
...

    {
        ...
        lv_label_set_text(lbl, view_intl_get_string(model, STRINGS_CHIAVETTA));
...
const pman_page_t page_archiving = {
    .create        = create_page,
